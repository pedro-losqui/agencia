...
<body class="boxed_wrapper">
    ...
    <section class="page-title" style="background-image: url(site/images/background/pagetitle-bg.png);">
        <div class="anim-icons">
            <div class="icon icon-1"><img
                    src="{{ asset('site/images/icons/anim-icon-17.png') }}" alt=""></div>
            <div class="icon icon-2 rotate-me"><img
                    src="{{ asset('site/images/icons/anim-icon-18.png') }}" alt=""></div>
            <div class="icon icon-3 rotate-me"><img
                    src="{{ asset('site/images/icons/anim-icon-19.png') }}" alt=""></div>
    ...
    <section class="error-section centred">
        <div class="container">
            <div class="content-box">
                ...
                <div class="text">Não conseguimos encontrar a página que você está procurando</div>
                <div class="btn-box"><a href="{{ route('home') }}" class="theme-btn-two">Voltar</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <footer class="main-footer style-five style-six">
        ...
        <div class="image-layer" style="background-image: url(site/images/icons/footer-bg-6.png);"></div>
        <div class="container">
