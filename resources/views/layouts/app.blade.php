            ...
            <div class="container-fluid">
                            ...
                            <div class="slimscroll noti-scroll">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                    <div class="notify-icon">
                                        <img src="admin/images/users/user-1.jpg" class="img-fluid rounded-circle"
                                            alt="" /> </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="admin/images/users/user-4.jpg" class="img-fluid rounded-circle"
                                            alt="" /> </div>
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo text-center">
                        <span class="logo-lg">
                            <img src="admin/images/logo-dark.png" alt="" height="26">
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li class="has-submenu">
                                    <a href="#"><i class="fe-bookmark mr-1"></i> Forms <div class="arrow-down"></div>
                                        </a>
                                    <ul class="submenu">
                                        <li>
                                ...
                                <li class="has-submenu">
                                    <a href="#"><i class="fe-bar-chart-2 mr-1"></i> Charts <div class="arrow-down">
                                        </div></a>
                                    <ul class="submenu">
                                        <li>
